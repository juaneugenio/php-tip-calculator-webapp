...
$results = null;
$transactionCount = getQuantityOfTransactions();
      ...
      <div class="column is-one-third-tablet is-one-third-desktop">
        ...
        <?php if ($results && is_array($results)): ?>
          <div class="box has-background-light">
            ...
            <h2 class="subtitle has-text-centered mb-4 has-text-weigth-bold is-size-4">Transaction Results</h2>
            <p class="has-text-left"><strong>Total Bill: </strong><span class="has-text-info has-text-weight-bold"><?= $results["total"] ?></span><small> EUR</small></p>
            <p class="has-text-left"><strong>Calculated Tip: </strong><?= $results["tip"] ?><small> EUR</small></p>
            <p class="has-text-centered has-text-info has-text-weight-bold mt-4">Total plus Tip:</p>
        ...
        if ($totals): ?>
          <div class="box has-background-light">
            ...
            <p class="has-text-left">Total transactions: <strong><?= $transactionCount ?></strong></p>
